      ...
      <div className='p-16 pr-[3.25rem] pb-[1.8575rem] pl-[2.06rem]'>
        ...
        {credential?.link_download?.url && (
          <Link
            ...
            className='relative z-10 cursor-pointer border-none inline-flex max-w-[47.22188rem] bg-[#293844] pr-[0.4375rem] h-[2.925rem] group'
          >
            <div className='m-0 w-fit pt-[1.15rem] px-4 pb-[0.73rem] text-white overflow-hidden flex flex-col'>
