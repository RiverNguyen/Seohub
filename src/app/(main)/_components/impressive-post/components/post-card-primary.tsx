...
export default function PostCardPrimary({
  ...
  return (
    <article
      className={clsx(
        'relative group cursor-pointer overflow-hidden rounded-[1.25rem] max-sm:rounded-[0.42219rem]',
        className,
      )}
    >
      ...
      <div className='absolute right-[1.67rem] bottom-[1.75rem] z-[1] max-sm:right-[0.5rem] max-sm:bottom-[0.5rem]'>
        <DetailWrapperSvgPC className='h-[3.75rem] w-[13.125em] max-sm:hidden transition-all duration-[600ms] ease-out lg:group-hover:fill-[#0BB] fill-[#00D3D0]' />
