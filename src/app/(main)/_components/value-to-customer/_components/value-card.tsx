...
export default function ValueCard({
  ...
  return (
    <article
      className={clsx(
        'relative p-[1.87163rem_6.375rem_1.87163rem_1.875rem] xsm:p-0 sm:min-h-[20.07rem]  flex items-start rounded-[0.875rem] bg-white shadow-[0px_-59.892px_74.865px_0px_rgba(3,33,7,0.04)] overflow-hidden xsm:px-[1.5475rem] xsm:pt-[1.475rem] max-sm:flex-col',
        className,
      )}
    >
      ...
      <div className='relative max-w-[33.1875rem] max-sm:self-stretch max-sm:mb-[6.3125rem]'>
      ...
      <Image
        ...
        height={1000}
        src={image_url}
        className='absolute bottom-0 left-[63rem] h-full w-auto z-[1] max-sm:left-0 max-sm:w-full max-sm:h-auto max-sm:static max-sm:self-stretch'
      />
    </article>
  )
}
