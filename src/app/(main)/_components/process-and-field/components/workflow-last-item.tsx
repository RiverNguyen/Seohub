  ...
  return (
    ...
    >
      <div className='flex flex-col justify-between h-full'>
        <div
          className='mt-[1.72rem] w-[24.12613rem] text-[3.625rem] leading-[1.19] font-normal text-white'
          dangerouslySetInnerHTML={{
            __html: workflow.subtitle ?? '',
          }}
        ></div>
        <div
          className='opacity-70 text-white text-xl font-normal leading-[150%] w-[33.42481rem]'
          dangerouslySetInnerHTML={{
        ...
        <Link
          href='/'
          className='vtc__link-detail hidden xsm:block'
        >
