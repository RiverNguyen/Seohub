    ...
    <>
      <div id='warpper_section'>
        <section
          id='snapping-section'
          ref={containerRef}
          className='relative w-full bg-[linear-gradient(180deg,#548BEB_0%,#1767F0_21.3%)] xsm:z-50'
        >
          <div
            id='layer-background'
          ...
          >
            ...
            <svg
              ...
              className='sm:absolute top-1/2 left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 w-[77.47363rem] h-[13.94525rem] transition-all duration-[0.7s] xsm:w-[19.875rem] xsm:h-[3.5625rem] xsm:ml-[1.81rem]'
            >
      ...
      <div className='sm:hidden w-full h-[15.6875rem] bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,#fff_100%)] relative z-50 border-none -mb-2'></div>
    </>
  )
}
