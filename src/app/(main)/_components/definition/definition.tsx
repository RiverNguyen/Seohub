...
const Definition = async () => {
  ...
  return (
    <>
      ...
      <section className='h-[50.625rem] relative mt-4 overflow-hidden'>
        <div className='absolute left-0 top-0 z-10 bg-no-repeat'>
          <Image
            ...
            alt=''
            className='w-[75rem] h-[36.25rem] opacity-50 bg-contain'
            draggable='false'
          />
        </div>
        ...
        <Image
          className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[42.28856rem] w-[67.66169rem] opacity-80 bg-no-repeat bg-cover z-20'
        ...
        <article className='flex items-center justify-between mt-20 w-[92.39375rem] max-w-full mx-auto'>
          ...
          <div className='flex flex-col items-end'>
            ...
            <h2
              ...
              className='text-[2.875rem] leading-[4rem] whitespace-nowrap text-right text-[#0725b7] font-normal'
            ></h2>
          </div>
        </article>
        <div className='flex w-[92.39375rem] max-w-full items-start justify-between mx-auto relative z-50'>
          <div className='grid grid-cols-2 gap-3 mt-[4.275rem]'>
            {definition.definition_tag.map((item) => (
              <div
                className='relative w-[16.7455rem] h-[11.151rem] definition__card'
              ...
              >
                ...
                <div
                  className='absolute z-20 opacity-0 scale-0 -top-4 right-14'
                  id='sparkle1'
                >
                  <Image
                ...
                <div
                  className='absolute z-20 opacity-0 scale-0 right-9 top-2'
                  id='sparkle2'
                >
                  <Image
                ...
                >
                  <div className='flex flex-col justify-center h-full'>
                    <p
                      className='relative text-[3.93488rem] font-bold leading-[3.66038rem] w-fit bg-gradient-to-b from-[#001cb3] to-[#548beb] bg-clip-text text-transparent'
                      id='cardNumber'
                    >
                      {item.definition_tag_emp}
                      <span
                        className='absolute -top-5 -right-4 text-[2.90363rem] leading-[2.70106rem] font-bold [-webkit-text-stroke:1.39px_#fff] bg-gradient-to-b from-[#ff7300] to-white bg-clip-text text-transparent'
                        id='cardPlus'
                      >
                        {item.value}
                      </span>
                    ...
                    <hr
                      className='border border-[#e2e2e2] my-3.5'
                      id='cardLine'
                    />
                    <p
                      className='text-base text-[#081d1a]'
                      id='cardText'
                    >
          ...
          <div className='-mr-[2rem] relative'>
            <div className='drawler'>
              <svg
                ...
                xmlns='http://www.w3.org/2000/svg'
                id='triangleSVG'
                className='w-[46.67963rem] h-[7.87013rem] ml-20 -mb-9'
              >
                <path
            ...
            <Image
              ...
              className='w-[54.20319rem] h-[25.10856rem] object-contain'
